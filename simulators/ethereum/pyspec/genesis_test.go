...
func TestGenesisParsing(t *testing.T) {
  ...
  "uncles": []
	...
	expectBlockHeader := blockHeader{
		...
		WithdrawalsRoot:  common.HexToHash("0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421"),
		GasLimit:         0x05f5e100,
		ExtraData:        []byte{0x0},
	...
	if diffs, err := compareGenesis(genesisResponse, expectBlockHeader); err == nil {
		fmt.Printf(diffs)
	}
}
