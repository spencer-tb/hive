...
type Engine interface {
	...
	NewPayload(ctx context.Context, version int, payload interface{}, versionedHashes *[]common.Hash, parentBeaconRoot *common.Hash) (api.PayloadStatusV1, error)
	...
	NewPayloadV3(ctx context.Context, payload *typ.ExecutableData, versionedHashes *[]common.Hash, parentBeaconRoot *common.Hash) (api.PayloadStatusV1, error)
